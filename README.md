...
High-level architectural review checklist (26 sections, 368 items) for manual verification. Unlike automated checks, this provides hints that cannot be automatically verified.
