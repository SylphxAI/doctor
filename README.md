...
High-level architectural review checklist (25 sections, 325 items) for manual verification. Unlike automated checks, this provides hints that cannot be automatically verified.
